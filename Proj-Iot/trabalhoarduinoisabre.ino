...
const char* ssid = "FAD1";             //SSID da rede WIFI
const char* password =  "2790";    //senha da rede wifi
//Informações da Instância do broker MQTT
const char* mqttServer = "broker.mqtt-dashboard.com";   //server
const char* mqttUser = "isabella";              //user
const char* mqttPassword = "BrendaIsabella10";      //password
